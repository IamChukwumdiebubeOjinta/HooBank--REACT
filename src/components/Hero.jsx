  ...
  <section 
    ...
    <div 
      ...
      <div className="flex flex-row justify-between items-center w-full">
        <h1 className='flex-1 text-white font-poppins font-semibold ss:text-[72px] text-[52px] ss:leading-[100px] leading-[75px]'>The Next <br className='sm:block hidden' /> {" "} <span className='text-gradient'>Generation</span> {" "}  </h1>
